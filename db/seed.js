...
async function createInitialUsers(){
    try {
        ...
        const sandra = await createUser({ username:'sandra', password: 'sandraPASS', name: 'Just Sandra', location: "Ain't Tellin", active: true});
        const glamgal = await createUser({ username: "glamgal", password: "glamPASS", name: 'Joshua', location: 'Upper East Side', active: true});
